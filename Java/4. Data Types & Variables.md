# What is Data Types?
A classification that specifies the type of value a variable can hold, the amount of memory it requires, and the operations that can be performed on it.
# What is a Variable?
...
**float vs double:** Always prefer `double`. It is more precise and is Java's default decimal type. Only use `float` when memory is critically limited.
...
Non-primitive types are **objects**, they are instances of classes.
##### 1. ==String==
